...
public class Page<T> implements Serializable {
    ...
    private static final long serialVersionUID = 3568550556173055035L;
     ...
     * 本页的数据列表
     */
    private List<T> recordList = new ArrayList<T>(100);
    ...
    public static int checkCurrentPage(int totalCount, int numPerPage,
                                       int currentPage) {
        int totalPage = Page.countTotalPage(totalCount, numPerPage);
