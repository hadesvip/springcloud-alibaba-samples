package com.kevin.quick.common.core.dao.impl;
...
import com.kevin.quick.common.core.dao.BaseDao;
...
public abstract class BaseDaoImpl<T extends BaseEntity> implements BaseDao<T> {
    ...
    public Page listPage(PageParam pageParam, Map<String, Object> paramMap) {
        ...
        // 校验当前页数
        int currentPage = Page.checkCurrentPage(totalCount.intValue(), pageParam.getNumPerPage(), pageParam.getPageNum());
        ...
        if (isCount != null && "1".equals(isCount.toString())) {
            ...
            return new Page(pageParam.getPageNum(), pageParam.getNumPerPage(), totalCount.intValue(), list, countResultMap);
        } else {
            // 构造分页对象
            return new Page(pageParam.getPageNum(), pageParam.getNumPerPage(), totalCount.intValue(), list);
        }
    }
